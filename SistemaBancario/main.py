...
conta_corrente.sacar("abc22")
conta_corrente.depositar(5000)
...
conta_poupanca = ContaPoupanca(id_conta=2, saldo=5000, taxa_de_rendimento=12)
conta_poupanca.verificar_rendimentos("por_segundo")
conta_poupanca.verificar_rendimentos("por_minuto")
conta_poupanca.verificar_rendimentos("por_hora")
conta_poupanca.verificar_rendimentos("diario")
conta_poupanca.verificar_rendimentos("mensal")
conta_poupanca.verificar_rendimentos("anual")
